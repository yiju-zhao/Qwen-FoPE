...
def load_model(
    ...
    if 'qwen2' in model_args.model_name_or_path.lower() and hasattr(model, 'model'):
        # Parameters are defined in Qwen2Model, so set them on model.model
        model.model.which_rope = model_args.which_rope
        model.model.fourier_learnable = model_args.fourier_learnable
        model.model.fourier_init = model_args.fourier_init
        model.model.fourier_dim = model_args.fourier_dim
        model.model.fourier_init_norm_gain = model_args.fourier_init_norm_gain
        model.model.fourier_separate_basis = model_args.fourier_separate_basis
        model.model.fourier_separate_head = model_args.fourier_separate_head
        model.model.fourier_norm = model_args.fourier_norm
        model.model.fourier_ignore_zero = model_args.fourier_ignore_zero
        
        logger.info_rank0(f"Loaded rope mode: {model.model.which_rope}")
